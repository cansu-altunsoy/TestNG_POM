...
public class Driver {
   ...
   private Driver(){
    ...
    public static WebDriver driver;  // ilk deger burda, null degeri atamasi yapar

    public static WebDriver getDriver() { // Bu method'un gorevi webdriver olusturmak ve dondurmek
